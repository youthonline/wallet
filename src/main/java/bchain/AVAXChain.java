 ...
 * 对接的C-Chain
 */
public class AVAXChain {

    private static AVAXChain instance = new AVAXChain();

    private AVAXChain() {
    }

    public static AVAXChain getInstance() {
        return instance;
    }
    ...
    /**
     * get tx status 0-unchecked(un deal)，1-success，2-failed
     *
     * @param web3j
     * @param txHash
     * @return
    ...
    public String getTokenBalance(Web3j web3j, String from, String conAddr) {
        ...
        if (null != result && result.size() > 0) {
            ...
            return BigDecimalUtils.toMax(balance.getValue().toString(), Integer.parseInt(decimals));
        }
        return "0";
    }
